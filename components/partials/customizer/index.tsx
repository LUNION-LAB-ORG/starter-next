    ...
    <Sheet>
      <SheetTrigger asChild>
        ...
        >
          ...
          />
          <span className="hidden md:inline-block  ms-2.5">Paramètre</span>
        </button>
      </SheetTrigger>
      <SheetContent className="lg:w-3/4 w-full max-w-full md:max-w-sm px-6 pt-0 pb-6 dark:border-r dark:border-default-300 bg-background">
