  ...
  return (
    <FooterContent>
      ...
      <div className="flex md:hidden justify-around items-center">
        ...
        <Link
          href="profile"
          className="relative bg-card bg-no-repeat backdrop-filter backdrop-blur-2xl rounded-full footer-bg dark:bg-default-300 h-[65px] w-[65px] z-[-1] -mt-[40px] flex justify-center items-center"
        >
