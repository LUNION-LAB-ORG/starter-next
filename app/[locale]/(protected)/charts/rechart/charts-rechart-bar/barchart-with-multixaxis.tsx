...
const CustomizedTick = (tickProps: any): React.JSX.Element | null => {
  ...
  return (
    <ResponsiveContainer width="100%" height={height}>
      <BarChart height={height} data={data}>
        ...
        <Legend
          formatter={(value: string, entry: any) => <span style={{ color: entry.color, marginRight: config.isRtl ? "5px" : "0px" }}>{value}</span>}
        />
        <Bar
          dataKey="pv"
          fill={colors.warning}
