                    ...
                    items?.map((item, i) => (
                      <tr key={i}>
                        ...
                        <td className=" px-3 py-3">
                          <div className="flex-1 h-8 w-[110px] flex border border border-default-900 delay-150 ease-in-out  divide-x rtl:divide-x-reverse text-sm font-normal divide-default-900  rounded">
