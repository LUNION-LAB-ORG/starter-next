    ...
    <>
      ...
      {show && (
        <div className="flex gap-4 items-center ">
          <div className="flex-1 h-8 flex border border border-default-900 delay-150 ease-in-out dark:border-default-600 divide-x rtl:divide-x-reverse text-sm font-normal divide-default-900 dark:divide-default-600 rounded">
            <button
