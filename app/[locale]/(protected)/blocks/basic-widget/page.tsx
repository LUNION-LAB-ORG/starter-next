        ...
        <div className="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
          <UpgradeBlock className="bg-default dark:bg-default-50">
            ...
            <div className="mt-6 mb-14 relative z-10">
              <Button className="bg-default-foreground text-default hover:bg-default-foreground hover:opacity-80 dark:bg-default dark:text-default-100 font-medium">
                Upgrade
              </Button>
            </div>
        ...
        <div className="grid xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
          <UpgradeBlock className="bg-default dark:bg-default-200 mt-14">
            ...
            <div className="mt-6">
              <Button
                size="lg"
                className="bg-primary-foreground dark:bg-white hover:ring-0  hover:ring-offset-0  ring-offset-transparent dark:text-default-100 hover:bg-primary-foreground hover:text-default hover:opacity-90 text-default w-full"
              >
                Upgrade
              </Button>
            </div>
            ...
            (item, index) => (
              <UpgradeBlock key={index} className={`bg-${item} mt-14`}>
                ...
                <div className="mt-6">
                  <Button
                    size="lg"
                    className="bg-primary-foreground hover:ring-0  hover:ring-offset-0 ring-offset-transparent dark:bg-white dark:text-default-100 hover:bg-primary-foreground hover:text-default hover:opacity-90 text-default w-full"
                  >
                    Upgrade
                  </Button>
                </div>
