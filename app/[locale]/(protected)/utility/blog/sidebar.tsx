        ...
        <ul className="list-item space-y-6">
          {category.map((item, i) => (
            <li key={i}>
              <Link
                href="#"
                className="flex space-x-1 items-start leading-none text-sm text-default-700 hover:text-default-900 transition duration-150 rtl:space-x-reverse"
              >
      ...
      <div className="mx-6 bg-default-900 dark:bg-default-50 text-primary-foreground dark:text-default rounded-xl p-6 space-y-4 mb-6">
        ...
        <form action="#" className="space-y-4">
          <Input
            ...
            className=" py-2 bg-transparent border-secondary focus:border-secondary placeholder-default-400 dark:placeholder-default-700"
          />
          <Button
            color="secondary"
            className="hover:outline-none hover:ring-0 hover:ring-offset-0 dark:bg-white dark:text-primary-foreground w-full"
          >
            Subscribe
          </Button>
        </form>
