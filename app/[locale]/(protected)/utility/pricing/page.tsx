        ...
        <Card>
          ...
          `}
                ...
                >
                  ...
                  {item.ribon && (
                    <div className="text-sm font-medium bg-default-900  text-default-foreground py-2 text-center absolute -right-[43px]  top-6 px-10 transform rotate-45 ">
                      {item.ribon}
                    </div>
                  )}
              ...
              ${
                ...
                `}
                  ...
                  <div>
                    {item.bg === "bg-default-900" ? (
                      <Button
                        className="border-default-200 border-solid border dark:bg-default-50 dark:hover:bg-default-100 dark:border-default-700 dark:text-default-700 dark:outline-0 dark:ring-0 dark:hover:ring-0 dark:hover:ring-offset-0 w-full"
                      >
                        {item.button}
                      </Button>
                    ) : (
                      <Button
                        className="dark:border-default-700 dark:text-default-700 dark:hover:bg-default-100 w-full"
                        variant="outline"
                      >
                        {item.button}
                      </Button>
