...
const MyProfile = () => {
  ...
  return (
    <div>
      ...
      <div
        className={cn(
          "absolute bg-card rounded-md   h-full start-0 top-0 bottom-0  w-full z-50",
          {
          ...
          <div className="p-6">
            <div className="flex justify-end">
              <Button
                size="icon"
                color="secondary"
                className="w-8 h-8 rouded-full"
                onClick={() =>
                  setChatConfig({ ...chatConfig, showProfile: false })
                }
              >
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="relative">
                ...
                <span
                  className={cn(
                    "absolute top-3 -end-[3px] h-3 w-3 rounded-full bg-success  border border-primary-foreground",
                    {
            ...
            <div className="my-8">
              <Label htmlFor="bio" className="mb-2 block text-default-900">
                {" "}
                About{" "}
              </Label>
            ...
            <div>
              <Label htmlFor="status" className="block mb-3 text-default-700">
                Status
              </Label>
